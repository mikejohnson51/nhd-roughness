...
The gradient boosted machine approach used is documented [here](./docs/GBM-final.html), and the predictions can be accessed with the `USGS-nhdplusTools` package
